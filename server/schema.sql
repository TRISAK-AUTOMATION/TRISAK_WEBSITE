...
CREATE TABLE home_content (
  ...
  hero_sub_en            TEXT,
  hero_sub_th            TEXT,
  hero_bg_image          VARCHAR(255),
  strength_eyebrow_en    VARCHAR(255),
  strength_eyebrow_th    VARCHAR(255),
  strength_title_en      VARCHAR(255),
  strength_title_th      VARCHAR(255),
...
INSERT INTO home_content (
  ...
  strength_eyebrow_en, strength_eyebrow_th, strength_title_en, strength_title_th,
